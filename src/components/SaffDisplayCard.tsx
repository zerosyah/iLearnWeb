...
import img1 from "../assets/staff/staff1.webp";
import img2 from "../assets/staff/staff2.webp";
import img3 from "../assets/staff/staff3.webp";
import img4 from "../assets/staff/staff4.webp";
import img5 from "../assets/staff/staff5.webp";
import img6 from "../assets/staff/staff6.webp";
import img7 from "../assets/staff/staff7.webp";
import img8 from "../assets/staff/staff8.webp";
import img9 from "../assets/staff/staff9.webp";
import img10 from "../assets/staff/staff10.webp";
...
function StaffDisplayCard({
  ...
  const containerStyle = `group relative h-[70vh] w-full overflow-hidden rounded-[16px] border border-white/20 bg-[#ececec] dark:bg-royalblue shadow-[0_18px_45px_rgba(15,23,42,0.12)] transition-all duration-300 md:h-[420px] md:w-[260px] ${
