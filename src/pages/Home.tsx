...
export default function Home() {
  ...
  return (
    <section className="h-screen">
      ...
      <section className="h-fit bg-[#D9D9D9] pt-4">
        <h1 className="text-center font-bebasNeue text-[30px] text-black">
          Explore our School activities
        </h1>
        <div className="flex flex-col items-center justify-center gap-8 md:pt-[56px] md:flex-row">
          <div className="">
      ...
      <section className="hidden h-[450px] items-center justify-evenly bg-[#D9D9D9] md:flex">
        <div className="">
          <img
      ...
      <section className="gap flex h-fit flex-col bg-[#FFFFFF]">
        <h1 className="text-wrap py-5 text-center font-popins  text-[30px] font-semibold uppercase text-black underline ">
          Student Support Program
        </h1>
        <div className="flex flex-col items-center justify-evenly gap-[20px] pb-[10px] text-center md:flex-row md:gap-0 md:pb-0 ">
          ...
          <div className="h-fit md:w-[407px] text-wrap font-robot text-[12px] text-black px-[10px] md:px-0">
      ...
      <section className="h-fit bg-[#D9D9D9] pt-4 md:h-[501px]">
        <h1 className="text-center font-popins text-[30px] font-semibold text-black underline px-[10px] md:px-0">
          Explore our School Sport Activities
        </h1>
        <div className="flex flex-col items-center justify-center gap-8 py-[20px] text-center">
          <div className="px-[10px] transition-all duration-500 ease-in-out md:px-0">
            <img
          ...
          <div className="">
            ...
            <p className="h-fit font-robot text-[12px] text-black md:w-[700px] px-[10px] md:px-0">
      ...
      <section className="gap flex h-fit flex-col bg-[#FFFFFF] md:h-[501px] py-[10px]">
        <h1 className="text-center font-bebasNeue text-[30px] text-black">
          Spacial Events
        </h1>
        <div className="flex flex-col items-center justify-evenly gap-[10px] md:flex-row">
          <div className="h-fit text-wrap px-[10px] text-center font-robot text-[12px] text-black md:w-[407px] md:px-0 ">
...
/**
 *  <section className="w-screen h-screen bg-red-600">
      <section
        className={`w-screen min-h-[720px] bg-red-700 rounded-b-[30px] absolute top-0 left-0 right-0 `}
      > 
        <Header />
        <div className=" mx-[40px] pt-[100px]">
          <h2 className="bg-clip-text font-pacifico text-[30px] uppercase text-white drop-shadow-[5px_5px_0px_rgba(0,0,0,3)] hidden md:inline-block">
            Welcome
          </h2>
