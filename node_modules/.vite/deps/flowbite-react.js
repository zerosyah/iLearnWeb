...
function IconBase(props) {
  var elem = function(conf) {
    var attr2 = props.attr, size2 = props.size, title = props.title, svgProps = __rest(props, ["attr", "size", "title"]);
    ...
    if ((0, import_react7.isValidElement)(child)) {
      if (child.props.children) {
        return (0, import_react7.cloneElement)(child, {
          ...
          positionInGroup: determinePosition(index2, import_react7.Children.count(children))
        });
      } else {
        return (0, import_react7.cloneElement)(child, {
          outline,
...
var Checkbox = (0, import_react12.forwardRef)(({ className, color = "default", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime21.jsx)("input", { ref, type: "checkbox", className: twMerge(theme2.root.base, theme2.root.color[color], className), ...props });
});
...
var DatepickerViewsDays = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime25.jsxs)(import_jsx_runtime25.Fragment, { children: [(0, import_jsx_runtime25.jsx)("div", { className: theme2.header.base, children: weekDays.map((day, index2) => (0, import_jsx_runtime25.jsx)("span", { className: theme2.header.title, children: day }, index2)) }), (0, import_jsx_runtime25.jsx)("div", { className: theme2.items.base, children: [...Array(42)].map((_date, index2) => {
    ...
    return (0, import_jsx_runtime25.jsx)("button", { disabled: isDisabled2, type: "button", className: twMerge(theme2.items.item.base, isSelected && theme2.items.item.selected, isDisabled2 && theme2.items.item.disabled), onClick: () => {
      if (isDisabled2)
        return;
...
var DatepickerViewsDecades = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime26.jsx)("div", { className: theme2.items.base, children: [...Array(12)].map((_year, index2) => {
    ...
    return (0, import_jsx_runtime26.jsx)("button", { disabled: isDisabled2, type: "button", className: twMerge(theme2.items.item.base, isSelected && theme2.items.item.selected, isDisabled2 && theme2.items.item.disabled), onClick: () => {
      if (isDisabled2)
        return;
      setViewDate(addYears(viewDate, year - selectedDate.getFullYear()));
      setView(Views.Years);
    }, children: year }, index2);
  }) });
};
...
var DatepickerViewsMonth = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime27.jsx)("div", { className: theme2.items.base, children: [...Array(12)].map((_month, index2) => {
    ...
    return (0, import_jsx_runtime27.jsx)("button", { disabled: isDisabled2, type: "button", className: twMerge(theme2.items.item.base, isSelected && theme2.items.item.selected, isDisabled2 && theme2.items.item.disabled), onClick: () => {
      if (isDisabled2)
        return;
      setViewDate(newDate);
      setView(Views.Days);
    }, children: month }, index2);
  }) });
};
...
var DatepickerViewsYears = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime28.jsx)("div", { className: theme2.items.base, children: [...Array(12)].map((_year, index2) => {
    ...
    const isSelected = isDateEqual(selectedDate, newDate);
    const isDisabled2 = !isDateInRange(newDate, minDate, maxDate);
    return (0, import_jsx_runtime28.jsx)("button", { disabled: isDisabled2, type: "button", className: twMerge(theme2.items.item.base, isSelected && theme2.items.item.selected, isDisabled2 && theme2.items.item.disabled), onClick: () => {
      if (isDisabled2)
        return;
      setViewDate(newDate);
...
function FloatingPortal(props) {
  ...
  return React4.createElement(PortalContext.Provider, {
    ...
    style: HIDDEN_STYLES
  }), portalNode && ReactDOM.createPortal(children, portalNode), shouldRenderGuards && portalNode && React4.createElement(FocusGuard, {
    "data-type": "outside",
    ref: afterOutsideRef,
    onFocus: (event) => {
      if (isOutsideEvent(event, portalNode)) {
...
var DropdownContext = (0, import_react22.createContext)(void 0);
function useDropdownContext() {
  const context = (0, import_react22.useContext)(DropdownContext);
  if (!context) {
...
var DropdownItem = (0, import_react24.forwardRef)(({ children, className, icon: Icon, onClick, theme: customTheme = {}, ...props }, forwardedRef) => {
...
var Trigger = ({ refs, children, inline: inline2, theme: theme2, disabled, setButtonWidth, getReferenceProps, renderTrigger, ...buttonProps }) => {
  ...
  return inline2 ? (0, import_jsx_runtime33.jsx)("button", { type: "button", ref: refs.setReference, className: theme2 == null ? void 0 : theme2.inlineWrapper, disabled, ...a11yProps, children }) : (0, import_jsx_runtime33.jsx)(Button, { ...buttonProps, disabled, type: "button", ref: refs.setReference, ...a11yProps, children });
};
var DropdownComponent = ({ children, className, dismissOnClick = true, theme: customTheme = {}, renderTrigger, ...props }) => {
  ...
  const handleSelect = (0, import_react26.useCallback)((index2) => {
    setSelectedIndex(index2);
    setOpen(false);
  }, []);
  const handleTypeaheadMatch = (0, import_react26.useCallback)((index2) => {
    if (open) {
...
var Flowbite = ({ children, theme: theme2 }) => {
  return (0, import_jsx_runtime37.jsxs)(import_jsx_runtime37.Fragment, { children: [(0, import_jsx_runtime37.jsx)(ThemeInit, { mode: theme2 == null ? void 0 : theme2.mode, theme: theme2 == null ? void 0 : theme2.theme }), children] });
};
...
var FooterCopyright = ({ by, className, href, theme: customTheme = {}, year, ...props }) => {
  ...
  return (0, import_jsx_runtime39.jsxs)("div", { "data-testid": "flowbite-footer-copyright", className: twMerge(theme2.base, className), ...props, children: ["© ", year, href ? (0, import_jsx_runtime39.jsx)("a", { href, className: theme2.href, children: by }) : (0, import_jsx_runtime39.jsx)("span", { "data-testid": "flowbite-footer-copyright-span", className: theme2.span, children: by })] });
};
...
var FooterLink = ({ as: Component = "a", children, className, href, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime42.jsx)("li", { className: twMerge(theme2.base, className), children: (0, import_jsx_runtime42.jsx)(Component, { href, className: theme2.href, ...props, children }) });
};
...
var FooterTitle = ({ as: Component = "h2", className, theme: customTheme = {}, title, ...props }) => {
  ...
  return (0, import_jsx_runtime44.jsx)(Component, { "data-testid": "flowbite-footer-title", className: twMerge(theme2.base, className), ...props, children: title });
};
...
var Label = ({ children, className, color = "default", disabled = false, theme: customTheme = {}, value, ...props }) => {
  ...
  return (0, import_jsx_runtime47.jsx)("label", { className: twMerge(theme2.root.base, theme2.root.colors[color], disabled && theme2.root.disabled, className), "data-testid": "flowbite-label", ...props, children: value ?? children ?? "" });
};
...
var ListComponent = ({ children, className, unstyled, nested, ordered, horizontal, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime49.jsx)(Component, { className: twMerge(theme2.root.base, theme2.root.ordered[ordered ? "on" : "off"], unstyled && theme2.root.unstyled, nested && theme2.root.nested, horizontal && theme2.root.horizontal, className), ...props, children });
};
...
var ModalHeader = ({ as: Component = "h3", children, className, theme: customTheme = {}, id, ...props }) => {
  ...
  return (0, import_jsx_runtime54.jsxs)("div", { className: twMerge(theme2.base, popup && theme2.popup, className), ...props, children: [(0, import_jsx_runtime54.jsx)(Component, { id: headerId, className: theme2.title, children }), (0, import_jsx_runtime54.jsx)("button", { "aria-label": "Close", className: theme2.close.base, type: "button", onClick: onClose, children: (0, import_jsx_runtime54.jsx)(HiOutlineX, { "aria-hidden": true, className: theme2.close.icon }) })] });
};

// node_modules/flowbite-react/lib/esm/components/Modal/Modal.js
var ModalComponent = (0, import_react32.forwardRef)(({ children, className, dismissible = false, onClose, popup, position = "center", root, show, size: size2 = "2xl", theme: customTheme = {}, initialFocus, ...props }, theirRef) => {
...
var NavbarBrand = ({ as: Component = "a", children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime56.jsx)(Component, { className: twMerge(theme2.base, className), ...props, children });
};
...
var NavbarLink = ({ active, as: Component = "a", disabled, children, className, theme: customTheme = {}, onClick, ...props }) => {
  ...
  return (0, import_jsx_runtime58.jsx)("li", { children: (0, import_jsx_runtime58.jsx)(Component, { className: twMerge(theme2.base, active && theme2.active.on, !active && !disabled && theme2.active.off, theme2.disabled[disabled ? "on" : "off"], className), onClick: handleClick, ...props, children }) });
};
...
var Progress = ({ className, color = "cyan", labelProgress = false, labelText = false, progress, progressLabelPosition = "inside", size: size2 = "md", textLabel = "progressbar", textLabelPosition = "inside", theme: customTheme = {}, ...props }) => {
  const id = (0, import_react35.useId)();
  const theme2 = mergeDeep(getTheme().progress, customTheme);
  return (0, import_jsx_runtime63.jsx)(import_jsx_runtime63.Fragment, { children: (0, import_jsx_runtime63.jsxs)("div", { id, "aria-label": textLabel, "aria-valuenow": progress, role: "progressbar", ...props, children: [(textLabel && labelText && textLabelPosition === "outside" || progress > 0 && labelProgress && progressLabelPosition === "outside") && (0, import_jsx_runtime63.jsxs)("div", { className: theme2.label, "data-testid": "flowbite-progress-outer-label-container", children: [textLabel && labelText && textLabelPosition === "outside" && (0, import_jsx_runtime63.jsx)("span", { "data-testid": "flowbite-progress-outer-text-label", children: textLabel }), labelProgress && progressLabelPosition === "outside" && (0, import_jsx_runtime63.jsxs)("span", { "data-testid": "flowbite-progress-outer-progress-label", children: [progress, "%"] })] }), (0, import_jsx_runtime63.jsx)("div", { className: twMerge(theme2.base, theme2.size[size2], className), children: (0, import_jsx_runtime63.jsxs)("div", { style: { width: `${progress}%` }, className: twMerge(theme2.bar, theme2.color[color], theme2.size[size2]), children: [textLabel && labelText && textLabelPosition === "inside" && (0, import_jsx_runtime63.jsx)("span", { "data-testid": "flowbite-progress-inner-text-label", children: textLabel }), progress > 0 && labelProgress && progressLabelPosition === "inside" && (0, import_jsx_runtime63.jsxs)("span", { "data-testid": "flowbite-progress-inner-progress-label", children: [progress, "%"] })] }) })] }) });
};
...
var Radio = (0, import_react36.forwardRef)(({ className, theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime64.jsx)("input", { ref, type: "radio", className: twMerge(theme2.root.base, className), ...props });
});
...
var RangeSlider = (0, import_react37.forwardRef)(({ className, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime65.jsx)(import_jsx_runtime65.Fragment, { children: (0, import_jsx_runtime65.jsx)("div", { "data-testid": "flowbite-range-slider", className: twMerge(theme2.root.base, className), children: (0, import_jsx_runtime65.jsx)("div", { className: theme2.field.base, children: (0, import_jsx_runtime65.jsx)("input", { ref, type: "range", className: twMerge(theme2.field.input.base, theme2.field.input.sizes[sizing]), ...props }) }) }) });
});
...
var RatingAdvanced = ({ children, className, percentFilled = 0, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime66.jsxs)("div", { className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime66.jsx)("span", { className: theme2.label, children }), (0, import_jsx_runtime66.jsx)("div", { className: theme2.progress.base, children: (0, import_jsx_runtime66.jsx)("div", { className: theme2.progress.fill, "data-testid": "flowbite-rating-fill", style: { width: `${percentFilled}%` } }) }), (0, import_jsx_runtime66.jsx)("span", { className: theme2.progress.label, children: `${percentFilled}%` })] });
};
...
var RatingStar = ({ className, filled = true, starIcon: Icon = HiStar, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime67.jsx)(Icon, { "data-testid": "flowbite-rating-star", className: twMerge(theme2.sizes[size2], theme2[filled ? "filled" : "empty"], className), ...props });
};
...
var RatingComponent = ({ children, className, size: size2 = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime68.jsx)(RatingContext.Provider, { value: { theme: theme2, size: size2 }, children: (0, import_jsx_runtime68.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
...
var Select = (0, import_react39.forwardRef)(({ addon, children, className, color = "gray", helperText, icon: Icon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime69.jsxs)("div", { className: twMerge(theme2.base, className), children: [addon && (0, import_jsx_runtime69.jsx)("span", { className: theme2.addon, children: addon }), (0, import_jsx_runtime69.jsxs)("div", { className: theme2.field.base, children: [Icon && (0, import_jsx_runtime69.jsx)("div", { className: theme2.field.icon.base, children: (0, import_jsx_runtime69.jsx)(Icon, { className: theme2.field.icon.svg }) }), (0, import_jsx_runtime69.jsx)("select", { className: twMerge(theme2.field.select.base, theme2.field.select.colors[color], theme2.field.select.sizes[sizing], theme2.field.select.withIcon[Icon ? "on" : "off"], theme2.field.select.withAddon[addon ? "on" : "off"], theme2.field.select.withShadow[shadow ? "on" : "off"]), ...props, ref, children }), helperText && (0, import_jsx_runtime69.jsx)(HelperText, { color, children: helperText })] })] });
});
...
var SidebarCTA = ({ children, color = "info", className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime70.jsx)("div", { "data-testid": "sidebar-cta", hidden: isCollapsed, className: twMerge(theme2.base, theme2.color[color], className), ...props, children });
};
...
var Tooltip = ({ animation = "duration-300", arrow: arrow2 = true, children, className, content, placement = "top", style = "dark", theme: customTheme = {}, trigger = "hover", ...props }) => {
  ...
  return (0, import_jsx_runtime72.jsx)(Floating, { animation, arrow: arrow2, content, placement, style, theme: theme2, trigger, className, ...props, children });
};
...
var ListItem2 = ({ id, theme: theme2, isCollapsed, tooltipChildren, children: wrapperChildren, ...props }) => (0, import_jsx_runtime74.jsx)("li", { ...props, children: isCollapsed ? (0, import_jsx_runtime74.jsx)(Tooltip, { content: (0, import_jsx_runtime74.jsx)(Children4, { id, theme: theme2, children: tooltipChildren }), placement: "right", children: wrapperChildren }) : wrapperChildren });
var Children4 = ({ id, theme: theme2, children }) => {
  return (0, import_jsx_runtime74.jsx)("span", { "data-testid": "flowbite-sidebar-item-content", id: `flowbite-sidebar-item-${id}`, className: twMerge(theme2.content.base), children });
};
...
var SidebarItemGroup = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime75.jsx)("ul", { "data-testid": "flowbite-sidebar-item-group", className: twMerge(theme2.base, className), ...props, children: (0, import_jsx_runtime75.jsx)(SidebarItemContext.Provider, { value: { isInsideCollapse: false }, children }) });
};
...
var SidebarItems = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime76.jsx)("div", { className: twMerge(theme2.base, className), "data-testid": "flowbite-sidebar-items", ...props, children });
};
...
var SidebarLogo = ({ children, className, href, img, imgAlt = "", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime77.jsxs)("a", { "aria-labelledby": `flowbite-sidebar-logo-${id}`, href, className: twMerge(theme2.base, className), ...props, children: [(0, import_jsx_runtime77.jsx)("img", { alt: imgAlt, src: img, className: theme2.img }), (0, import_jsx_runtime77.jsx)("span", { className: theme2.collapsed[isCollapsed ? "on" : "off"], id: `flowbite-sidebar-logo-${id}`, children })] });
};
...
var SidebarComponent = ({ children, as: Component = "nav", collapseBehavior = "collapse", collapsed: isCollapsed = false, theme: customTheme = {}, className, ...props }) => {
  ...
  return (0, import_jsx_runtime78.jsx)(SidebarContext.Provider, { value: { theme: theme2, isCollapsed }, children: (0, import_jsx_runtime78.jsx)(Component, { "aria-label": "Sidebar", hidden: isCollapsed && collapseBehavior === "hide", className: twMerge(theme2.root.base, theme2.root.collapsed[isCollapsed ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime78.jsx)("div", { className: theme2.root.inner, children }) }) });
};
...
// node_modules/flowbite-react/lib/esm/components/Table/TableBody.js
var TableBody = (0, import_react49.forwardRef)(({ children, className, theme: customTheme = {}, ...props }, ref) => {
  const { theme: rootTheme } = useTableContext();
  const theme2 = mergeDeep(rootTheme.body, customTheme);
  return (0, import_jsx_runtime79.jsx)(TableBodyContext.Provider, { value: { theme: theme2 }, children: (0, import_jsx_runtime79.jsx)("tbody", { className: twMerge(theme2.base, className), ref, ...props, children }) });
});
...
var TableCell = (0, import_react50.forwardRef)(({ children, className, theme: customTheme = {}, ...props }, ref) => {
  const { theme: bodyTheme } = useTableBodyContext();
  const theme2 = mergeDeep(bodyTheme.cell, customTheme);
  return (0, import_jsx_runtime80.jsx)("td", { className: twMerge(theme2.base, className), ref, ...props, children });
});
...
var TableHeadContext = (0, import_react51.createContext)(void 0);
function useTableHeadContext() {
  const context = (0, import_react51.useContext)(TableHeadContext);
  if (!context) {
...
// node_modules/flowbite-react/lib/esm/components/Table/TableHead.js
var TableHead = (0, import_react52.forwardRef)(({ children, className, theme: customTheme = {}, ...props }, ref) => {
  const { theme: rootTheme } = useTableContext();
  const theme2 = mergeDeep(rootTheme.head, customTheme);
  return (0, import_jsx_runtime81.jsx)(TableHeadContext.Provider, { value: { theme: theme2 }, children: (0, import_jsx_runtime81.jsx)("thead", { className: twMerge(theme2.base, className), ref, ...props, children: (0, import_jsx_runtime81.jsx)("tr", { children }) }) });
});
...
var TableHeadCell = (0, import_react53.forwardRef)(({ children, className, theme: customTheme = {}, ...props }, ref) => {
  const { theme: headTheme } = useTableHeadContext();
  const theme2 = mergeDeep(headTheme.cell, customTheme);
  return (0, import_jsx_runtime82.jsx)("th", { className: twMerge(theme2.base, className), ref, ...props, children });
});
...
var TableRow = (0, import_react54.forwardRef)(({ children, className, theme: customTheme = {}, ...props }, ref) => {
  const { theme: rootTheme, hoverable, striped } = useTableContext();
  const theme2 = mergeDeep(rootTheme.row, customTheme);
  return (0, import_jsx_runtime83.jsx)("tr", { ref, "data-testid": "table-row-element", className: twMerge(theme2.base, striped && theme2.striped, hoverable && theme2.hovered, className), ...props, children });
});
TableRow.displayName = "Table.Row";

// node_modules/flowbite-react/lib/esm/components/Table/Table.js
var TableComponent = (0, import_react55.forwardRef)(({ children, className, striped, hoverable, theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(getTheme().table, customTheme);
  return (0, import_jsx_runtime84.jsx)("div", { "data-testid": "table-element", className: twMerge(theme2.root.wrapper), children: (0, import_jsx_runtime84.jsxs)(TableContext.Provider, { value: { theme: theme2, striped, hoverable }, children: [(0, import_jsx_runtime84.jsx)("div", { className: twMerge(theme2.root.shadow, className) }), (0, import_jsx_runtime84.jsx)("table", { className: twMerge(theme2.root.base, className), ...props, ref, children })] }) });
});
...
var TabItem = ({ children, className }) => (0, import_jsx_runtime85.jsx)("div", { className, children });
TabItem.displayName = "Tabs.Item";

// node_modules/flowbite-react/lib/esm/components/Tabs/Tabs.js
var import_jsx_runtime86 = __toESM(require_jsx_runtime());
var import_react56 = __toESM(require_react());
var TabsComponent = (0, import_react56.forwardRef)(({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(getTheme().tabs, customTheme);
  const id = (0, import_react56.useId)();
  const tabs = (0, import_react56.useMemo)(() => import_react56.Children.map(import_react56.Children.toArray(children), ({ props: props2 }) => props2), [children]);
  const tabRefs = (0, import_react56.useRef)([]);
  const [activeTab, setActiveTab] = (0, import_react56.useState)(Math.max(0, tabs.findIndex((tab) => tab.active)));
  const [focusedTab, setFocusedTab] = (0, import_react56.useState)(-1);
  ...
  return (0, import_jsx_runtime86.jsxs)("div", { className: twMerge(theme2.base, className), children: [(0, import_jsx_runtime86.jsx)("div", { "aria-label": "Tabs", role: "tablist", className: twMerge(theme2.tablist.base, theme2.tablist.styles[style], className), ...props, children: tabs.map((tab, index2) => (0, import_jsx_runtime86.jsxs)("button", { type: "button", "aria-controls": `${id}-tabpanel-${index2}`, "aria-selected": index2 === activeTab, className: twMerge(theme2.tablist.tabitem.base, tabItemStyle.base, index2 === activeTab && tabItemStyle.active.on, index2 !== activeTab && !tab.disabled && tabItemStyle.active.off), disabled: tab.disabled, id: `${id}-tab-${index2}`, onClick: () => handleClick({ target: index2 }), onKeyDown: (event) => handleKeyboard({ event, target: index2 }), ref: (element) => tabRefs.current[index2] = element, role: "tab", tabIndex: index2 === focusedTab ? 0 : -1, style: { zIndex: index2 === focusedTab ? 2 : 1 }, children: [tab.icon && (0, import_jsx_runtime86.jsx)(tab.icon, { className: theme2.tablist.tabitem.icon }), tab.title] }, index2)) }), (0, import_jsx_runtime86.jsx)("div", { className: twMerge(theme2.tabitemcontainer.base, tabItemContainerStyle), children: tabs.map((tab, index2) => (0, import_jsx_runtime86.jsx)("div", { "aria-labelledby": `${id}-tab-${index2}`, className: theme2.tabpanel, hidden: index2 !== activeTab, id: `${id}-tabpanel-${index2}`, role: "tabpanel", tabIndex: 0, children: tab.children }, index2)) })] });
});
...
var Textarea = (0, import_react57.forwardRef)(({ className, color = "gray", helperText, shadow, theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(getTheme().textarea, customTheme);
  return (0, import_jsx_runtime87.jsxs)(import_jsx_runtime87.Fragment, { children: [(0, import_jsx_runtime87.jsx)("textarea", { ref, className: twMerge(theme2.base, theme2.colors[color], theme2.withShadow[shadow ? "on" : "off"], className), ...props }), helperText && (0, import_jsx_runtime87.jsx)(HelperText, { color, children: helperText })] });
});
...
var ThemeModeScript = ({ mode, ...others }) => {
  return (0, import_jsx_runtime88.jsx)("script", { ...others, "data-flowbite-theme-mode-script": true, dangerouslySetInnerHTML: {
...
var TimelineContentContext = (0, import_react58.createContext)(void 0);
function useTimelineContentContext() {
  const context = (0, import_react58.useContext)(TimelineContentContext);
  if (!context) {
...
var TimelineBody = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime89.jsx)("div", { className: twMerge(theme2.base, className), ...props, children });
};
...
var TimelineContext = (0, import_react59.createContext)(void 0);
function useTimelineContext() {
  const context = (0, import_react59.useContext)(TimelineContext);
  if (!context) {
...
var TimelineItemContext = (0, import_react60.createContext)(void 0);
function useTimelineItemContext() {
  const context = (0, import_react60.useContext)(TimelineItemContext);
  if (!context) {
...
var TimelineContent = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime90.jsx)(TimelineContentContext.Provider, { value: { theme: theme2 }, children: (0, import_jsx_runtime90.jsx)("div", { "data-testid": "timeline-content", className: twMerge(horizontal && theme2.root.base, className), ...props, children }) });
};
...
var TimelineItem = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  const theme2 = mergeDeep(rootTheme.item, customTheme);
  return (0, import_jsx_runtime91.jsx)(TimelineItemContext.Provider, { value: { theme: theme2 }, children: (0, import_jsx_runtime91.jsx)("li", { "data-testid": "timeline-item", className: twMerge(horizontal && theme2.root.horizontal, !horizontal && theme2.root.vertical, className), ...props, children }) });
};
...
var TimelinePoint = ({ children, className, icon: Icon, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime92.jsxs)("div", { "data-testid": "timeline-point", className: twMerge(horizontal && theme2.horizontal, !horizontal && theme2.vertical, className), ...props, children: [children, Icon ? (0, import_jsx_runtime92.jsx)("span", { className: twMerge(theme2.marker.icon.wrapper), children: (0, import_jsx_runtime92.jsx)(Icon, { "aria-hidden": true, className: twMerge(theme2.marker.icon.base) }) }) : (0, import_jsx_runtime92.jsx)("div", { className: twMerge(horizontal && theme2.marker.base.horizontal, !horizontal && theme2.marker.base.vertical) }), horizontal && (0, import_jsx_runtime92.jsx)("div", { className: twMerge(theme2.line) })] });
};
...
var TimelineTime = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime93.jsx)("time", { className: twMerge(theme2.base, className), ...props, children });
};
...
var TimelineTitle = ({ as: Tag = "h3", children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime94.jsx)(Tag, { className: twMerge(theme2.base, className), ...props, children });
};
...
var TimelineComponent = ({ children, className, horizontal, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime95.jsx)(TimelineContext.Provider, { value: { theme: theme2, horizontal }, children: (0, import_jsx_runtime95.jsx)("ol", { "data-testid": "timeline-component", className: twMerge(horizontal && theme2.root.direction.horizontal, !horizontal && theme2.root.direction.vertical, className), ...props, children }) });
};
...
var ToastContext = (0, import_react61.createContext)(void 0);
function useToastContext() {
  const context = (0, import_react61.useContext)(ToastContext);
  if (!context) {
...
var ToastToggle = ({ className, onClick, theme: customTheme = {}, xIcon: XIcon = HiX, onDismiss, ...props }) => {
  ...
  return (0, import_jsx_runtime96.jsx)("button", { "aria-label": "Close", onClick: handleClick, type: "button", className: twMerge(theme2.base, className), ...props, children: (0, import_jsx_runtime96.jsx)(XIcon, { "aria-hidden": true, className: theme2.icon }) });
};
...
var ToastComponent = ({ children, className, duration = 300, theme: customTheme = {}, ...props }) => {
  const [isClosed, setIsClosed] = (0, import_react62.useState)(false);
  const [isRemoved, setIsRemoved] = (0, import_react62.useState)(false);
  const theme2 = mergeDeep(getTheme().toast, customTheme);
  if (isRemoved) {
    return null;
  }
  return (0, import_jsx_runtime97.jsx)(ToastContext.Provider, { value: { theme: theme2, duration, isClosed, isRemoved, setIsClosed, setIsRemoved }, children: (0, import_jsx_runtime97.jsx)("div", { "data-testid": "flowbite-toast", role: "alert", className: twMerge(theme2.root.base, durationClasses[duration], isClosed && theme2.root.closed, className), ...props, children }) });
};
...
var ToggleSwitch = (0, import_react63.forwardRef)(({ checked, className, color = "blue", sizing = "md", disabled, label, name, onChange, theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime98.jsxs)(import_jsx_runtime98.Fragment, { children: [name && checked ? (0, import_jsx_runtime98.jsx)("input", { ref, checked, hidden: true, name, readOnly: true, type: "checkbox", className: "sr-only" }) : null, (0, import_jsx_runtime98.jsxs)("button", { "aria-checked": checked, "aria-labelledby": `${id}-flowbite-toggleswitch-label`, disabled, id: `${id}-flowbite-toggleswitch`, onClick: handleClick, onKeyDown: handleOnKeyDown, role: "switch", tabIndex: 0, type: "button", className: twMerge(theme2.root.base, theme2.root.active[disabled ? "off" : "on"], className), ...props, children: [(0, import_jsx_runtime98.jsx)("div", { "data-testid": "flowbite-toggleswitch-toggle", className: twMerge(theme2.toggle.base, theme2.toggle.checked[checked ? "on" : "off"], checked && theme2.toggle.checked.color[color], theme2.toggle.sizes[sizing]) }), (label == null ? void 0 : label.length) ? (0, import_jsx_runtime98.jsx)("span", { "data-testid": "flowbite-toggleswitch-label", id: `${id}-flowbite-toggleswitch-label`, className: theme2.root.label, children: label }) : null] })] });
});
...
function Popover({ children, content, theme: customTheme = {}, arrow: arrow2 = true, trigger = "click", initialOpen, open: controlledOpen, onOpenChange: setControlledOpen, placement: theirPlacement = "bottom", ...props }) {
  const [uncontrolledOpen, setUncontrolledOpen] = (0, import_react64.useState)(Boolean(initialOpen));
  const arrowRef = (0, import_react64.useRef)(null);
  ...
  if (!(0, import_react64.isValidElement)(children)) {
    throw Error("Invalid target element");
  }
  const target = (0, import_react64.useMemo)(() => {
    return (0, import_react64.cloneElement)(children, getReferenceProps({
      ref,
      "data-testid": "flowbite-popover-target",
      ...children == null ? void 0 : children.props
    }));
  }, [children, ref, getReferenceProps]);
  return (0, import_jsx_runtime99.jsxs)(import_jsx_runtime99.Fragment, { children: [target, open && (0, import_jsx_runtime99.jsx)(FloatingFocusManager, { context, modal: true, children: (0, import_jsx_runtime99.jsx)("div", { className: theme2.base, ref: refs.setFloating, "data-testid": "flowbite-popover", ...props, style: floatingStyles, ...getFloatingProps(), children: (0, import_jsx_runtime99.jsxs)("div", { className: "relative", children: [arrow2 && (0, import_jsx_runtime99.jsx)("div", { className: theme2.arrow.base, "data-testid": "flowbite-popover-arrow", ref: arrowRef, style: {
    top: arrowY ?? " ",
    left: arrowX ?? " ",
    right: " ",
    bottom: " ",
    [getArrowPlacement({ placement })]: theme2.arrow.placement
  }, children: " " }), (0, import_jsx_runtime99.jsx)("div", { className: theme2.content, children: content })] }) }) })] });
}
export {
  Accordion,
  AccordionContent,
