...
var InteractionContext = React3.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React3.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React3.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
function useLineSeries() {
  const series = useSeries();
  return React15.useMemo(() => series.line, [series.line]);
}
...
function CartesianProvider(props) {
  ...
  const xValues = React19.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React19.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
...
function useChartId() {
  ...
  return React20.useMemo(() => chartId, [chartId]);
}
...
var ZAxisContext = React21.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React21.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime7.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime7.jsxs)(React24.Fragment, {
...
function useChartGradient() {
  ...
  return React26.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var HighlightedContext = React27.createContext({
  isInitialized: false,
  data: {
...
var AnimationContext = React32.createContext({
  isInitialized: false,
  data: {
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React33.useContext(AnimationContext);
  if (!isInitialized) {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React34.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React35.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var ChartsSurface = React36.forwardRef(function ChartsSurface2(inProps, ref) {
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React37.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React37.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React38.useRef(null);
...
var useChartContainerDimensions = (inWidth, inHeight, resolveSizeBeforeRender) => {
  ...
  const computeSize = React40.useCallback(() => {
...
var ResponsiveChartContainer = React41.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
...
function ChartsText(props) {
  ...
  const wordsByLines = React42.useMemo(() => getWordsByLines({
    style,
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime18.jsxs)(React46.Fragment, {
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React47.useState(null);
  React47.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React51.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React51.useMemo(() => {
...
function LegendPerItem(props) {
  ...
  const theme = useTheme();
  const drawingArea = useDrawingArea();
  const labelStyle = React56.useMemo(
  ...
  const padding = React56.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React56.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React56.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React56.useMemo(() => {
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime28.jsxs)(React60.Fragment, {
...
function ChartsAxisHighlight(props) {
  ...
  const {
    axis
  } = React62.useContext(InteractionContext);
  ...
  return (0, import_jsx_runtime30.jsxs)(React62.Fragment, {
...
//# sourceMappingURL=chunk-UW7UONGI.js.map
