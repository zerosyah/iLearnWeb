import {
  ...
  serializeStyles,
  styled
} from "./chunk-4VYFNY4W.js";
import "./chunk-KRX2OWMK.js";
import {
  require_react_dom
} from "./chunk-LPDS7DTP.js";
import {
  require_jsx_runtime
...
function hexToRgb(color3) {
  ...
  return colors3 ? `rgb${colors3.length === 4 ? "a" : ""}(${colors3.map((n, index2) => {
...
function useDefaultProps({
  ...
  const ctx2 = React25.useContext(PropsContext);
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider2(props) {
    ...
    const ctx2 = React29.useContext(ColorSchemeContext);
...
function value_default(a2, b) {
  var t = typeof b, c6;
  return b == null || t === "boolean" ? constant_default2(b) : (t === "number" ? number_default : t === "string" ? (c6 = color2(b)) ? (b = c6, rgb_default) : string_default : b instanceof color2 ? rgb_default : b instanceof Date ? date_default : isNumberArray(b) ? numberArray_default : Array.isArray(b) ? genericArray : typeof b.valueOf !== "function" && typeof b.toString !== "function" || isNaN(b) ? object_default : number_default)(a2, b);
}
...
function transformer() {
  ...
  function scale(x2) {
    return x2 == null || isNaN(x2 = +x2) ? unknown : (output || (output = piecewise2(domain.map(transform), range2, interpolate2)))(transform(clamp3(x2)));
  }
  scale.invert = function(y2) {
    return clamp3(untransform((input || (input = piecewise2(range2, domain.map(transform), number_default)))(y2)));
  };
  scale.domain = function(_) {
...
function transformer2() {
  var x0 = 0, x1 = 1, t03, t13, k10, transform, interpolator = identity3, clamp3 = false, unknown;
  function scale(x2) {
    return x2 == null || isNaN(x2 = +x2) ? unknown : interpolator(k10 === 0 ? 0.5 : (x2 = (transform(x2) - t03) * k10, clamp3 ? Math.max(0, Math.min(1, x2)) : x2));
  }
  scale.domain = function(_) {
...
var useChartDimensions = (width2, height2, margin2) => {
  ...
  const drawingArea = React39.useMemo(() => ({
...
var DrawingContext = React40.createContext({
  top: 0,
  left: 0,
  bottom: 0,
  right: 0,
...
var SvgContext = React40.createContext({
  isInitialized: false,
  data: {
    current: null
  }
...
function DrawingProvider(props) {
  ...
  const chartId = useId();
  const isPointInside = React40.useCallback(({
    x: x2,
    y: y2
  }, options) => {
  ...
  const value = React40.useMemo(() => _extends({
    chartId: chartId ?? ""
  }, drawingArea, {
    isPointInside
  }), [chartId, drawingArea, isPointInside]);
  const refValue = React40.useMemo(() => ({
    isInitialized: true,
    data: svgRef
  }), [svgRef]);
...
function useDrawingArea() {
  const {
    ...
    right: right2,
    isPointInside
  } = React41.useContext(DrawingContext);
...
var SeriesContext = React42.createContext({
  isInitialized: false,
  data: {}
});
if (true) {
...
var PluginContext = React43.createContext({
  isInitialized: false,
  data: {
    colorProcessors: {},
    seriesFormatters: {},
...
function PluginProvider(props) {
  ...
  const formattedSeries = React44.useMemo(() => ({
    isInitialized: true,
...
function useColorProcessor(seriesType) {
  const {
    isInitialized,
    data
  } = React45.useContext(PluginContext);
  if (!isInitialized) {
...
function useSeriesFormatter(seriesType) {
  const {
    isInitialized,
    data
  } = React46.useContext(PluginContext);
  if (!isInitialized) {
    throw new Error(["MUI X: Could not find the plugin context.", "It looks like you rendered your component outside of a ChartsContainer parent component."].join("\n"));
  }
  if (!seriesType) {
...
function useXExtremumGetter(seriesType) {
  const {
    isInitialized,
    data
  } = React47.useContext(PluginContext);
  if (!isInitialized) {
    throw new Error(["MUI X: Could not find the plugin context.", "It looks like you rendered your component outside of a ChartsContainer parent component."].join("\n"));
  }
  if (!seriesType) {
...
function useYExtremumGetter(seriesType) {
  const {
    isInitialized,
    data
  } = React48.useContext(PluginContext);
  if (!isInitialized) {
    throw new Error(["MUI X: Could not find the plugin context.", "It looks like you rendered your component outside of a ChartsContainer parent component."].join("\n"));
  }
  if (!seriesType) {
...
function SeriesProvider(props) {
  ...
  const formattedSeries = React51.useMemo(() => ({
    isInitialized: true,
...
function useSeries() {
  const {
    isInitialized,
    data
  } = React52.useContext(SeriesContext);
  if (!isInitialized) {
...
function useLineSeries() {
  ...
  return React52.useMemo(() => series.line, [series.line]);
}

// node_modules/@mui/x-charts/context/CartesianProvider/CartesianContext.js
var React53 = __toESM(require_react());
var CartesianContext = React53.createContext({
  isInitialized: false,
  data: {
    xAxis: {},
    yAxis: {},
...
function CartesianProvider(props) {
  ...
  const xValues = React54.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React54.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
...
var useCartesianContext = () => {
  const {
    data
  } = React55.useContext(CartesianContext);
  return data;
};
...
var InteractionContext = React56.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React56.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React56.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var HighlightedContext = React57.createContext({
  isInitialized: false,
  data: {
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React58.useMemo(() => {
  ...
  const providerValue = React58.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
  ...
  return (0, import_jsx_runtime23.jsx)(HighlightedContext.Provider, {
    value: providerValue,
    children
  });
}
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React59.useContext(HighlightedContext);
  if (!isInitialized) {
...
var ZAxisContext = React60.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React60.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
  ...
  return (0, import_jsx_runtime24.jsx)(ZAxisContext.Provider, {
    value,
    children
  });
}
true ? ZAxisContextProvider.propTypes = {
   ...
   */
  zAxis: import_prop_types22.default.arrayOf(import_prop_types22.default.shape({
  ...
  return {
    ...
    flush(arg2) {
      if (current.size) {
        ...
        eachSafely(current, (fn) => fn(arg2) && next.add(fn));
...
var clamp2 = (min3, max3, v) => Math.min(Math.max(v, min3), max3);
var colors2 = {
  transparent: 0,
...
function interpolate(input, inputMin, inputMax, outputMin, outputMax, easing2, extrapolateLeft, extrapolateRight, map4) {
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react12.forwardRef)((givenProps, givenRef) => {
    ...
    return React62.createElement(Component, { ...usedProps, ref });
  });
};
...
var getDisplayName2 = (arg2) => is.str(arg2) ? arg2 : arg2 && is.str(arg2.displayName) ? arg2.displayName : is.fun(arg2) && arg2.name || null;
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React63.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React63.createContext(init));
...
var SpringRef = () => {
  ...
  const _getProps = function(arg2, ctrl, index2) {
    return is.fun(arg2) ? arg2(index2, ctrl) : arg2;
  };
...
var useStringInterpolator = (path2) => {
  ...
  const interpolator = React64.useMemo(() => memoryRef.previousPath ? string_default(memoryRef.previousPath, memoryRef.currentPath) : () => memoryRef.currentPath, [memoryRef.currentPath, memoryRef.previousPath]);
  return interpolator;
};
...
function useChartId() {
  const {
    chartId
  } = React65.useContext(DrawingContext);
  return React65.useMemo(() => chartId, [chartId]);
}
...
function AppearingMask(props) {
  ...
  return (0, import_jsx_runtime25.jsxs)(React68.Fragment, {
    children: [(0, import_jsx_runtime25.jsx)("clipPath", {
      id: clipId,
      children: transitionAppear((style4) => (0, import_jsx_runtime25.jsx)(animated.rect, {
        // @ts-expect-error
        x: 0,
        y: 0,
        width: style4.animatedWidth,
        height: drawingArea.top + drawingArea.height + drawingArea.bottom
      }))
    }), (0, import_jsx_runtime25.jsx)("g", {
      clipPath: `url(#${clipId})`,
...
var AreaElementPath = styled_default2(animated.path, {
  ...
  stroke: "none",
  fill: ownerState.gradientId && `url(#${ownerState.gradientId})` || ownerState.isHighlighted && color2(ownerState.color).brighter(1).formatHex() || color2(ownerState.color).brighter(0.5).formatHex(),
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime26.jsx)(AppearingMask, {
    skipAnimation: skipAnimation2,
    id: `${ownerState.id}-area-clip`,
    children: transitionChange((style4, interpolator) => (
      // @ts-expect-error
      (0, import_jsx_runtime26.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
        d: style4.value.to(interpolator)
      }))
    ))
  });
}
true ? AnimatedArea.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  d: import_prop_types23.default.string.isRequired,
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime27.jsx)(Area, _extends({}, other, areaProps));
}
true ? AreaElement.propTypes = {
  ...
  d: import_prop_types24.default.string.isRequired,
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime28.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime28.jsxs)(React71.Fragment, {
        children: [(0, import_jsx_runtime28.jsx)("stop", {
          offset,
          stopColor: colorMap.colors[index2],
          stopOpacity: 1
        }), (0, import_jsx_runtime28.jsx)("stop", {
          offset,
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime29.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime29.jsx)("stop", {
        offset,
        stopColor: color3,
        stopOpacity: 1
      }, keyPrefix + index2);
...
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime30.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime30.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime30.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse2,
          scale,
          colorScale,
          colorMap,
...
var AnimationContext = React74.createContext({
  isInitialized: false,
  data: {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React75.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
  ...
  return (0, import_jsx_runtime31.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React76.useContext(AnimationContext);
  if (!isInitialized) {
...
function AreaPlot(props) {
  ...
  return (0, import_jsx_runtime32.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      area,
      gradientUsed
    }) => !!area && (0, import_jsx_runtime32.jsx)(AreaElement, {
      id: seriesId,
      d,
      color: color3,
...
var LineElementPath = styled_default2(animated.path, {
  ...
  fill: "none",
  stroke: ownerState.gradientId && `url(#${ownerState.gradientId})` || ownerState.isHighlighted && color2(ownerState.color).brighter(0.5).formatHex() || ownerState.color,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(AppearingMask, {
    skipAnimation: skipAnimation2,
    id: `${ownerState.id}-line-clip`,
    children: transitionChange((style4, interpolator) => (
      // @ts-expect-error
      (0, import_jsx_runtime33.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: style4.value.to(interpolator)
      }))
    ))
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime34.jsx)(Line, _extends({}, other, lineProps));
}
...
function LinePlot(props) {
  ...
  return (0, import_jsx_runtime35.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      d,
      seriesId,
      color: color3,
      ...
      return (0, import_jsx_runtime35.jsx)(LineElement, {
        id: seriesId,
        d,
        color: color3,
        gradientId: gradientUsed && getGradientId(...gradientUsed),
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const {
    dispatch
  } = React81.useContext(InteractionContext);
  const usedXAxis = xAxisIds[0];
  const usedYAxis = yAxisIds[0];
  const mousePosition = React81.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var ChartsSurface = React82.forwardRef(function ChartsSurface2(inProps, ref) {
  ...
  return (0, import_jsx_runtime36.jsxs)(ChartChartsSurfaceStyles, _extends({
    width: width2,
    height: height2,
    ...
    children: [(0, import_jsx_runtime36.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime36.jsx)("desc", {
      children: desc
    }), children]
  }));
});
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React83.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React83.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React84.useRef(null);
...
var ChartContainer = React85.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
  ...
  return (0, import_jsx_runtime37.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime37.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime37.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime37.jsx)(CartesianProvider, _extends({}, cartesianProviderProps, {
          children: (0, import_jsx_runtime37.jsx)(ZAxisContextProvider, _extends({}, zAxisContextProps, {
            children: (0, import_jsx_runtime37.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime37.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime37.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
                  children: [(0, import_jsx_runtime37.jsx)(ChartsAxesGradients, {}), (0, import_jsx_runtime37.jsx)(AnimationProvider, _extends({}, animationProviderProps, {
                    children
                  }))]
                }))
              }))
...
true ? ChartContainer.propTypes = {
  ...
  highlightedItem: import_prop_types30.default.shape({
    ...
    seriesId: import_prop_types30.default.oneOfType([import_prop_types30.default.number, import_prop_types30.default.string])
  }),
  /**
   ...
   */
  margin: import_prop_types30.default.shape({
   ...
   */
  plugins: import_prop_types30.default.arrayOf(import_prop_types30.default.object),
  /**
  ...
  viewBox: import_prop_types30.default.shape({
    height: import_prop_types30.default.number,
    width: import_prop_types30.default.number,
    x: import_prop_types30.default.number,
    y: import_prop_types30.default.number
  }),
  /**
   * The width of the chart in px.
   */
   ...
   */
  xAxis: import_prop_types30.default.arrayOf(import_prop_types30.default.shape({
    ...
    labelFontSize: import_prop_types30.default.number,
    labelStyle: import_prop_types30.default.object,
    max: import_prop_types30.default.oneOfType([import_prop_types30.default.instanceOf(Date), import_prop_types30.default.number]),
    min: import_prop_types30.default.oneOfType([import_prop_types30.default.instanceOf(Date), import_prop_types30.default.number]),
    position: import_prop_types30.default.oneOf(["bottom", "top"]),
    reverse: import_prop_types30.default.bool,
    scaleType: import_prop_types30.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    ...
    sx: import_prop_types30.default.oneOfType([import_prop_types30.default.arrayOf(import_prop_types30.default.oneOfType([import_prop_types30.default.func, import_prop_types30.default.object, import_prop_types30.default.bool])), import_prop_types30.default.func, import_prop_types30.default.object]),
    tickFontSize: import_prop_types30.default.number,
   ...
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types30.default.arrayOf(import_prop_types30.default.shape({
    classes: import_prop_types30.default.object,
    colorMap: import_prop_types30.default.oneOfType([import_prop_types30.default.shape({
      colors: import_prop_types30.default.arrayOf(import_prop_types30.default.string).isRequired,
      type: import_prop_types30.default.oneOf(["ordinal"]).isRequired,
    ...
    max: import_prop_types30.default.oneOfType([import_prop_types30.default.instanceOf(Date), import_prop_types30.default.number]),
    min: import_prop_types30.default.oneOfType([import_prop_types30.default.instanceOf(Date), import_prop_types30.default.number]),
    position: import_prop_types30.default.oneOf(["left", "right"]),
    reverse: import_prop_types30.default.bool,
    scaleType: import_prop_types30.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types30.default.object,
    slots: import_prop_types30.default.object,
...
var useChartContainerDimensions = (inWidth, inHeight, resolveSizeBeforeRender) => {
  const stateRef = React86.useRef({
    displayError: false,
    initialCompute: true,
    computeRun: 0
  });
  const rootRef = React86.useRef(null);
  const [width2, setWidth] = React86.useState(0);
  const [height2, setHeight] = React86.useState(0);
  const computeSize = React86.useCallback(() => {
...
var ResponsiveChartContainer = React87.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
  } = useResponsiveChartContainerProps(props, ref);
  return (0, import_jsx_runtime38.jsx)(ResizableContainer, _extends({}, resizableChartContainerProps, {
    children: hasIntrinsicSize ? (0, import_jsx_runtime38.jsx)(ChartContainer, _extends({}, chartContainerProps)) : null
  }));
});
true ? ResponsiveChartContainer.propTypes = {
  ...
  highlightedItem: import_prop_types31.default.shape({
    ...
    seriesId: import_prop_types31.default.oneOfType([import_prop_types31.default.number, import_prop_types31.default.string])
  }),
  /**
   * The margin between the SVG and the drawing area.
   * It's used for leaving some space for extra information such as the x- and y-axis or legend.
   ...
   * @default object Depends on the charts type.
   */
  margin: import_prop_types31.default.shape({
   ...
   * If not provided, the container supports line, bar, scatter and pie charts.
   */
  plugins: import_prop_types31.default.arrayOf(import_prop_types31.default.object),
  /**
   ...
   * @default false
   */
  resolveSizeBeforeRender: import_prop_types31.default.bool,
  /**
   * The array of series to display.
   * Each type of series has its own specificity.
   * Please refer to the appropriate docs page to learn more about it.
  ...
  viewBox: import_prop_types31.default.shape({
    height: import_prop_types31.default.number,
    width: import_prop_types31.default.number,
    x: import_prop_types31.default.number,
    y: import_prop_types31.default.number
  }),
  /**
   ...
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types31.default.arrayOf(import_prop_types31.default.shape({
    ...
    labelFontSize: import_prop_types31.default.number,
    labelStyle: import_prop_types31.default.object,
    max: import_prop_types31.default.oneOfType([import_prop_types31.default.instanceOf(Date), import_prop_types31.default.number]),
    min: import_prop_types31.default.oneOfType([import_prop_types31.default.instanceOf(Date), import_prop_types31.default.number]),
    position: import_prop_types31.default.oneOf(["bottom", "top"]),
    reverse: import_prop_types31.default.bool,
    scaleType: import_prop_types31.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    ...
    sx: import_prop_types31.default.oneOfType([import_prop_types31.default.arrayOf(import_prop_types31.default.oneOfType([import_prop_types31.default.func, import_prop_types31.default.object, import_prop_types31.default.bool])), import_prop_types31.default.func, import_prop_types31.default.object]),
    tickFontSize: import_prop_types31.default.number,
   ...
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types31.default.arrayOf(import_prop_types31.default.shape({
    classes: import_prop_types31.default.object,
    colorMap: import_prop_types31.default.oneOfType([import_prop_types31.default.shape({
      colors: import_prop_types31.default.arrayOf(import_prop_types31.default.string).isRequired,
      type: import_prop_types31.default.oneOf(["ordinal"]).isRequired,
    ...
    max: import_prop_types31.default.oneOfType([import_prop_types31.default.instanceOf(Date), import_prop_types31.default.number]),
    min: import_prop_types31.default.oneOfType([import_prop_types31.default.instanceOf(Date), import_prop_types31.default.number]),
    position: import_prop_types31.default.oneOf(["left", "right"]),
    reverse: import_prop_types31.default.bool,
    scaleType: import_prop_types31.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types31.default.object,
    slots: import_prop_types31.default.object,
...
var _excluded11 = ["x", "y", "id", "classes", "color", "dataIndex", "onClick", "skipAnimation", "shape"];
function CircleMarkElement(props) {
  ...
  if (shape2 !== "circle") {
    warnOnce([`MUI X: The mark element of your line chart have shape "${shape2}" which is not supported when using \`experimentalRendering=true\`.`, 'Only "circle" are supported with `experimentalRendering`.'].join("\n"), "error");
  }
  const theme = useTheme4();
  const getInteractionItemProps = useInteractionItemProps();
  const {
  ...
  const {
    axis
  } = React88.useContext(InteractionContext);
  ...
  return (0, import_jsx_runtime39.jsx)(animated.circle, _extends({}, other, {
    // @ts-expect-error
    cx: position2.x,
    cy: position2.y,
    r: 5,
...
var _excluded12 = ["x", "y", "id", "classes", "color", "shape", "dataIndex", "onClick", "skipAnimation"];
...
function MarkElement(props) {
  ...
  const {
    axis
  } = React89.useContext(InteractionContext);
  const position2 = useSpring({
    to: {
      x: x2,
      y: y2
  ...
  const classes = useUtilityClasses4(ownerState);
  return (0, import_jsx_runtime40.jsx)(MarkElementPath, _extends({}, other, {
    style: {
...
var _excluded13 = ["slots", "slotProps", "skipAnimation", "onItemClick", "experimentalRendering"];
function MarkPlot(props) {
  ...
  const defaultXAxisId = xAxisIds[0];
  const defaultYAxisId = yAxisIds[0];
  return (0, import_jsx_runtime41.jsx)("g", _extends({}, other, {
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime41.jsx)("g", {
          ...
          children: xData == null ? void 0 : xData.map((x2, index2) => {
            ...
            return (0, import_jsx_runtime41.jsx)(Mark, _extends({
              id: seriesId,
              dataIndex: index2,
              shape: "circle",
...
var _excluded14 = ["x", "y", "style", "text", "ownerState"];
...
function ChartsText(props) {
  const {
    ...
    style: styleProps,
    text
  } = props, textProps = _objectWithoutPropertiesLoose(props, _excluded14);
  const _ref = styleProps ?? {}, {
    angle,
    textAnchor,
    dominantBaseline
  } = _ref, style4 = _objectWithoutPropertiesLoose(_ref, _excluded22);
  const wordsByLines = React91.useMemo(() => getWordsByLines({
    style: style4,
  ...
  return (0, import_jsx_runtime42.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style: style4,
    children: wordsByLines.map((line, index2) => (0, import_jsx_runtime42.jsx)("tspan", {
      x: x2,
...
true ? ChartsText.propTypes = {
   ...
   */
  lineHeight: import_prop_types35.default.number,
  /**
   * If `true`, the line width is computed.
   * @default false
   */
  needsComputation: import_prop_types35.default.bool,
  ownerState: import_prop_types35.default.any,
  /**
   ...
   * Text displayed.
   */
  text: import_prop_types35.default.string.isRequired
} : void 0;
...
function useMounted(defer = false) {
  const [mountedState, setMountedState] = React92.useState(false);
  useEnhancedEffect_default(() => {
    if (!defer) {
...
var _excluded15 = ["scale", "tickNumber", "reverse"];
...
function ChartsXAxis(inProps) {
  ...
  const _xAxis = xAxis[inProps.axisId ?? xAxisIds[0]], {
    ...
    tickNumber,
    reverse: reverse2
  } = _xAxis, settings = _objectWithoutPropertiesLoose(_xAxis, _excluded15);
  ...
  return (0, import_jsx_runtime43.jsxs)(XAxisRoot, {
    transform: `translate(0, ${position2 === "bottom" ? top2 + height2 : top2})`,
    className: classes.root,
    sx,
    children: [!disableLine && (0, import_jsx_runtime43.jsx)(Line, _extends({
      x1: left2,
      x2: left2 + width2,
      ...
      return (0, import_jsx_runtime43.jsxs)("g", {
        ...
        children: [!disableTicks && showTick && (0, import_jsx_runtime43.jsx)(Tick, _extends({
          y2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && showTickLabel && (0, import_jsx_runtime43.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
    ...
    }), label && (0, import_jsx_runtime43.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime43.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
true ? ChartsXAxis.propTypes = {
   ...
   * @default false
   */
  disableLine: import_prop_types36.default.bool,
  /**
   * If true, the ticks are disabled.
   * @default false
   */
  disableTicks: import_prop_types36.default.bool,
  /**
   * The fill color of the axis text.
   * @default 'currentColor'
   */
  fill: import_prop_types36.default.string,
  /**
   ...
   */
  labelFontSize: import_prop_types36.default.number,
  /**
   ...
   */
  position: import_prop_types36.default.oneOf(["bottom", "top"]),
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   * @default 'currentColor'
   */
  stroke: import_prop_types36.default.string,
   ...
   */
  tickFontSize: import_prop_types36.default.number,
  /**
   ...
   * @default 'auto'
   */
  tickInterval: import_prop_types36.default.oneOfType([import_prop_types36.default.oneOf(["auto"]), import_prop_types36.default.array, import_prop_types36.default.func]),
  /**
   ...
   * @default 'auto'
   */
  tickLabelInterval: import_prop_types36.default.oneOfType([import_prop_types36.default.oneOf(["auto"]), import_prop_types36.default.func]),
  /**
   * The placement of ticks label. Can be the middle of the band, or the tick position.
   * Only used if scale is 'band'.
   * @default 'middle'
   */
  tickLabelPlacement: import_prop_types36.default.oneOf(["middle", "tick"]),
  /**
   * The style applied to ticks text.
   */
  tickLabelStyle: import_prop_types36.default.object,
  /**
   * Maximal step between two ticks.
   * When using time data, the value is assumed to be in ms.
   * Not supported by categorical axis (band, points).
   */
  tickMaxStep: import_prop_types36.default.number,
  /**
   * Minimal step between two ticks.
   * When using time data, the value is assumed to be in ms.
   * Not supported by categorical axis (band, points).
   */
  tickMinStep: import_prop_types36.default.number,
  /**
   * The number of ticks. This number is not guaranteed.
   * Not supported by categorical axis (band, points).
   */
  tickNumber: import_prop_types36.default.number,
  /**
   * The placement of ticks in regard to the band interval.
   * Only used if scale is 'band'.
   * @default 'extremities'
   */
  tickPlacement: import_prop_types36.default.oneOf(["end", "extremities", "middle", "start"]),
  /**
   * The size of the ticks.
   * @default 6
   */
  tickSize: import_prop_types36.default.number
} : void 0;
...
var _excluded16 = ["scale", "tickNumber"];
...
function ChartsYAxis(inProps) {
  ...
  const _yAxis = yAxis[inProps.axisId ?? yAxisIds[0]], {
    scale: yScale,
    tickNumber
  } = _yAxis, settings = _objectWithoutPropertiesLoose(_yAxis, _excluded16);
  const themedProps = useThemeProps2({
    props: _extends({}, settings, inProps),
    name: "MuiChartsYAxis"
  });
  ...
  return (0, import_jsx_runtime44.jsxs)(YAxisRoot, {
    transform: `translate(${position2 === "right" ? left2 + width2 : left2}, 0)`,
    className: classes.root,
    sx,
    children: [!disableLine && (0, import_jsx_runtime44.jsx)(Line, _extends({
      y1: top2,
      y2: top2 + height2,
      className: classes.line
      ...
      return (0, import_jsx_runtime44.jsxs)("g", {
        transform: `translate(0, ${offset})`,
        className: classes.tickContainer,
        children: [!disableTicks && (0, import_jsx_runtime44.jsx)(Tick, _extends({
          x2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime44.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
      }, index2);
    }), label && (0, import_jsx_runtime44.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime44.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime45.jsxs)(React95.Fragment, {
    children: [topId && (0, import_jsx_runtime45.jsx)(ChartsXAxis, _extends({}, topAxisProps, {
      position: "top",
      axisId: topId
    })), bottomId && (0, import_jsx_runtime45.jsx)(ChartsXAxis, _extends({}, bottomAxisProps, {
      position: "bottom",
      axisId: bottomId
    })), leftId && (0, import_jsx_runtime45.jsx)(ChartsYAxis, _extends({}, leftAxisProps, {
      position: "left",
      axisId: leftId
    })), rightId && (0, import_jsx_runtime45.jsx)(ChartsYAxis, _extends({}, rightAxisProps, {
      position: "right",
      axisId: rightId
    }))]
  });
...
var Portal = React96.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  } = props;
  const [mountNode, setMountNode] = React96.useState(null);
  const handleRef = useForkRef(React96.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React96.isValidElement(children)) {
      ...
      return React96.cloneElement(children, newProps);
    }
    return children;
  }
...
var PopperTooltip = React97.forwardRef(function PopperTooltip2(props, forwardedRef) {
  const {
    anchorEl,
    children,
    direction,
  ...
  const tooltipRef = React97.useRef(null);
  const ownRef = useForkRef(tooltipRef, forwardedRef);
  const popperRef = React97.useRef(null);
  const handlePopperRef = useForkRef(popperRef, popperRefProp);
  const handlePopperRefRef = React97.useRef(handlePopperRef);
  useEnhancedEffect_default(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React97.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React97.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React97.useState(resolveAnchorEl(anchorEl));
  React97.useEffect(() => {
  ...
  return (0, import_jsx_runtime46.jsx)(Root, {
    ...rootProps,
    children: typeof children === "function" ? children(childProps) : children
  });
});
var Popper = React97.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
  ...
  const [exited, setExited] = React97.useState(true);
  const handleEnter = () => {
    setExited(false);
  };
  const handleExited = () => {
  ...
  return (0, import_jsx_runtime46.jsx)(Portal_default, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime46.jsx)(PopperTooltip, {
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
true ? Popper.propTypes = {
   ...
   */
  anchorEl: chainPropTypes(import_prop_types40.default.oneOfType([HTMLElementType, import_prop_types40.default.object, import_prop_types40.default.func]), (props) => {
    if (props.open) {
   ...
   * @default 'ltr'
   */
  direction: import_prop_types40.default.oneOf(["ltr", "rtl"]),
  /**
   * The `children` will be under the DOM hierarchy of the parent component.
   * @default false
   */
...
function GlobalStyles3(props) {
  return (0, import_jsx_runtime47.jsx)(GlobalStyles_default, {
    ...props,
    defaultTheme: defaultTheme_default,
    themeId: identifier_default
  });
...
function DefaultPropsProvider2(props) {
  return (0, import_jsx_runtime49.jsx)(DefaultPropsProvider_default, {
    ...props
  });
}
true ? DefaultPropsProvider2.propTypes = {
   ...
   * @ignore
   */
  value: import_prop_types42.default.object.isRequired
} : void 0;
...
var Popper3 = React101.forwardRef(function Popper4(inProps, ref) {
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime50.jsx)(PopperRoot, {
    as: component,
...
true ? Popper3.propTypes = {
   ...
   * The return value will passed as the reference object of the Popper instance.
   */
  anchorEl: import_prop_types43.default.oneOfType([HTMLElementType, import_prop_types43.default.object, import_prop_types43.default.func]),
  /**
   * Popper render function or node.
   */
  children: import_prop_types43.default.oneOfType([import_prop_types43.default.node, import_prop_types43.default.func]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
   ...
   * @default 'bottom'
   */
  placement: import_prop_types43.default.oneOf(["auto-end", "auto-start", "auto", "bottom-end", "bottom-start", "bottom", "left-end", "left-start", "left", "right-end", "right-start", "right", "top-end", "top-start", "top"]),
  /**
   * Options provided to the [`Popper.js`](https://popper.js.org/docs/v2/constructors/#options) instance.
   * @default {}
   */
  popperOptions: import_prop_types43.default.shape({
    modifiers: import_prop_types43.default.array,
    onFirstUpdate: import_prop_types43.default.func,
    placement: import_prop_types43.default.oneOf(["auto-end", "auto-start", "auto", "bottom-end", "bottom-start", "bottom", "left-end", "left-start", "left", "right-end", "right-start", "right", "top-end", "top-start", "top"]),
    strategy: import_prop_types43.default.oneOf(["absolute", "fixed"])
  }),
  /**
   * A ref that points to the used popper instance.
   */
   ...
   * @default false
   */
  transition: import_prop_types43.default.bool
} : void 0;
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React103.useState(null);
  React103.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function DefaultChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime51.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.paper,
    children: (0, import_jsx_runtime51.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime51.jsx)("tbody", {
        children: (0, import_jsx_runtime51.jsxs)(ChartsTooltipRow, {
          className: classes.row,
          children: [(0, import_jsx_runtime51.jsx)(ChartsTooltipCell, {
            className: clsx_default(classes.markCell, classes.cell),
            children: (0, import_jsx_runtime51.jsx)(ChartsTooltipMark, {
              color: color3,
              className: classes.mark
            })
          }), (0, import_jsx_runtime51.jsx)(ChartsTooltipCell, {
...
true ? DefaultChartsItemTooltipContent.propTypes = {
   ...
   */
  getColor: import_prop_types45.default.func.isRequired,
  /**
   * The data used to identify the triggered item.
   */
  itemData: import_prop_types45.default.shape({
    ...
    type: import_prop_types45.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
  }).isRequired,
  /**
...
function ChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime52.jsx)(Content, _extends({}, chartTooltipContentProps));
}
...
var Typography = React106.forwardRef(function Typography2(inProps, ref) {
  const {
    color: color3,
    ...themeProps
  } = useDefaultProps2({
  ...
  return (0, import_jsx_runtime53.jsx)(TypographyRoot, {
    as: Component,
    ref,
    className: clsx_default(classes.root, className),
    ...other,
...
true ? Typography.propTypes = {
   ...
   * @default 'inherit'
   */
  align: import_prop_types46.default.oneOf(["center", "inherit", "justify", "left", "right"]),
  /**
   * The content of the component.
   */
   ...
   * @default false
   */
  gutterBottom: import_prop_types46.default.bool,
  /**
   ...
   * @default false
   */
  noWrap: import_prop_types46.default.bool,
  /**
   * If `true`, the element will be a paragraph element.
   * @default false
   * @deprecated Use the `component` prop instead. This prop will be removed in v7. See [Migrating from deprecated APIs](https://mui.com/material-ui/migration/migrating-from-deprecated-apis/) for more details.
   */
  paragraph: import_prop_types46.default.bool,
  /**
   * @ignore
   */
   ...
   * }
   */
  variantMapping: import_prop_types46.default.object
} : void 0;
var Typography_default = Typography;
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime54.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.paper,
    children: (0, import_jsx_runtime54.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime54.jsx)("thead", {
        children: (0, import_jsx_runtime54.jsx)(ChartsTooltipRow, {
          children: (0, import_jsx_runtime54.jsx)(ChartsTooltipCell, {
            colSpan: 3,
            children: (0, import_jsx_runtime54.jsx)(Typography_default, {
      ...
      }), (0, import_jsx_runtime54.jsx)("tbody", {
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime54.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime54.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color3 && (0, import_jsx_runtime54.jsx)(ChartsTooltipMark, {
                color: color3,
                className: classes.mark
              })
            }), (0, import_jsx_runtime54.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime54.jsx)(Typography_default, {
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types47.default.object.isRequired,
  /**
   * Data identifying the triggered axis.
   */
  axisData: import_prop_types47.default.shape({
    x: import_prop_types47.default.shape({
      index: import_prop_types47.default.number,
      value: import_prop_types47.default.oneOfType([import_prop_types47.default.instanceOf(Date), import_prop_types47.default.number, import_prop_types47.default.string]).isRequired
    }),
    y: import_prop_types47.default.shape({
      index: import_prop_types47.default.number,
      value: import_prop_types47.default.oneOfType([import_prop_types47.default.instanceOf(Date), import_prop_types47.default.number, import_prop_types47.default.string]).isRequired
    })
  }).isRequired,
   ...
   */
  axisValue: import_prop_types47.default.oneOfType([import_prop_types47.default.instanceOf(Date), import_prop_types47.default.number, import_prop_types47.default.string]),
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsAxisTooltipContent(props) {
  ...
  const {
    zAxisIds,
    zAxis
  } = React108.useContext(ZAxisContext);
  const series = useSeries();
  const colorProcessors = useColorProcessor();
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React108.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React108.useMemo(() => {
  ...
  return (0, import_jsx_runtime55.jsx)(Content, _extends({}, chartTooltipContentProps));
}
...
function ChartsTooltip(inProps) {
  ...
  return (0, import_jsx_runtime56.jsx)(NoSsr_default, {
    children: popperOpen && (0, import_jsx_runtime56.jsx)(PopperComponent, _extends({}, popperProps, {
      className: classes.root,
      children: trigger === "item" ? (0, import_jsx_runtime56.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime56.jsx)(ChartsAxisTooltipContent, {
...
function ChartsLegendItem(props) {
  ...
  return (0, import_jsx_runtime57.jsxs)("g", {
    ...
    }), (0, import_jsx_runtime57.jsx)("rect", {
    ...
    }), (0, import_jsx_runtime57.jsx)(ChartsText, {
      style: _extends({
        pointerEvents: "none"
      }, labelStyle),
      text: label,
...
var _excluded18 = ["rotate", "dominantBaseline"];
...
function LegendPerItem(props) {
  ...
  const theme = useTheme4();
  const drawingArea = useDrawingArea();
  const labelStyle = React113.useMemo(
  ...
  const padding2 = React113.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React113.useCallback((label, inStyle = {}) => {
    const style4 = _objectWithoutPropertiesLoose(inStyle, _excluded18);
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React113.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React113.useMemo(() => {
  ...
  return (0, import_jsx_runtime58.jsx)(NoSsr_default, {
    children: (0, import_jsx_runtime58.jsx)(ChartsLegendRoot, {
...
var _excluded19 = ["drawingArea", "seriesToDisplay", "hidden", "onItemClick"];
...
function DefaultChartsLegend(props) {
  ...
  return (0, import_jsx_runtime59.jsx)(LegendPerItem, _extends({}, other, {
...
true ? DefaultChartsLegend.propTypes = {
   ...
   */
  direction: import_prop_types49.default.oneOf(["column", "row"]).isRequired,
  /**
   * @deprecated Use the `useDrawingArea` hook instead.
   */
  drawingArea: import_prop_types49.default.shape({
    bottom: import_prop_types49.default.number.isRequired,
    height: import_prop_types49.default.number.isRequired,
    left: import_prop_types49.default.number.isRequired,
    right: import_prop_types49.default.number.isRequired,
   ...
   * @default 10
   */
  itemGap: import_prop_types49.default.number,
  /**
   * Height of the item mark (in px).
   * @default 20
   */
  itemMarkHeight: import_prop_types49.default.number,
  /**
   * Width of the item mark (in px).
   * @default 20
   */
  itemMarkWidth: import_prop_types49.default.number,
  /**
   ...
   * @default 5
   */
  markGap: import_prop_types49.default.number,
  /**
   ...
   * @default 10
   */
  padding: import_prop_types49.default.oneOfType([import_prop_types49.default.number, import_prop_types49.default.shape({
   ...
   */
  position: import_prop_types49.default.shape({
    horizontal: import_prop_types49.default.oneOf(["left", "middle", "right"]).isRequired,
    vertical: import_prop_types49.default.oneOf(["bottom", "middle", "top"]).isRequired
  }).isRequired,
  series: import_prop_types49.default.object.isRequired,
  seriesToDisplay: import_prop_types49.default.arrayOf(import_prop_types49.default.shape({
    ...
    itemId: import_prop_types49.default.oneOfType([import_prop_types49.default.number, import_prop_types49.default.string]),
    label: import_prop_types49.default.string.isRequired,
    maxValue: import_prop_types49.default.oneOfType([import_prop_types49.default.instanceOf(Date), import_prop_types49.default.number]),
    minValue: import_prop_types49.default.oneOfType([import_prop_types49.default.instanceOf(Date), import_prop_types49.default.number]),
...
function ChartsLegend(inProps) {
  ...
  const {
    slots,
    slotProps
  } = defaultizedProps, other = _objectWithoutPropertiesLoose(defaultizedProps, _excluded20);
  const theme = useTheme4();
  const classes = useUtilityClasses10(_extends({}, defaultizedProps, {
    theme
  }));
  const drawingArea = useDrawingArea();
  const series = useSeries();
  ...
  return (0, import_jsx_runtime60.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
true ? ChartsLegend.propTypes = {
   ...
   * @default 10
   */
  itemGap: import_prop_types50.default.number,
  /**
   * Height of the item mark (in px).
   * @default 20
   */
  itemMarkHeight: import_prop_types50.default.number,
  /**
   * Width of the item mark (in px).
   * @default 20
   */
  itemMarkWidth: import_prop_types50.default.number,
  /**
   * Style applied to legend labels.
   * @default theme.typography.subtitle1
   */
   ...
   * @default 5
   */
  markGap: import_prop_types50.default.number,
  /**
   * Callback fired when a legend item is clicked.
   * @param {React.MouseEvent<SVGRectElement, MouseEvent>} event The click event.
   * @param {SeriesLegendItemContext} legendItem The legend item data.
   ...
   * @default 10
   */
  padding: import_prop_types50.default.oneOfType([import_prop_types50.default.number, import_prop_types50.default.shape({
...
function useAxis({
  ...
  const {
    zAxis,
    zAxisIds
  } = React116.useContext(ZAxisContext);
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime61.jsxs)(React117.Fragment, {
    children: [(0, import_jsx_runtime61.jsx)(ChartsContinuousGradient, {
      isReversed,
      gradientId: id,
      size,
    ...
    }), (0, import_jsx_runtime61.jsx)(ChartsText, {
      text: text1,
    ...
    }), (0, import_jsx_runtime61.jsx)("rect", _extends({
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types51.default.oneOf(["end", "middle", "start"]),
  /**
   * The axis direction containing the color configuration to represent.
   * @default 'z'
   */
  axisDirection: import_prop_types51.default.oneOf(["x", "y", "z"]),
  /**
   * The id of the axis item with the color configuration to represent.
   * @default The first axis item.
   */
  axisId: import_prop_types51.default.oneOfType([import_prop_types51.default.number, import_prop_types51.default.string]),
  /**
   * The direction of the legend layout.
   * The default depends on the chart.
   */
  direction: import_prop_types51.default.oneOf(["column", "row"]),
  /**
   ...
   * @default theme.typography.subtitle1
   */
  labelStyle: import_prop_types51.default.object,
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types51.default.oneOfType([import_prop_types51.default.number, import_prop_types51.default.string]),
  /**
   ...
   */
  maxLabel: import_prop_types51.default.oneOfType([import_prop_types51.default.func, import_prop_types51.default.string]),
  /**
   * The label to display at the minimum side of the gradient.
   * Can either be a string, or a function.
   * @default ({ formattedValue }) => formattedValue
   */
  minLabel: import_prop_types51.default.oneOfType([import_prop_types51.default.func, import_prop_types51.default.string]),
  /**
   * The position of the legend.
   */
  position: import_prop_types51.default.shape({
    horizontal: import_prop_types51.default.oneOf(["left", "middle", "right"]).isRequired,
    vertical: import_prop_types51.default.oneOf(["bottom", "middle", "top"]).isRequired
  }),
  /**
   * The scale used to display gradient colors.
   * @default 'linear'
   */
  scaleType: import_prop_types51.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
   * The space between the gradient bar and the labels.
   * @default 4
   */
  spacing: import_prop_types51.default.number,
  /**
   * The thickness of the gradient bar.
   * @default 5
   */
  thickness: import_prop_types51.default.number
} : void 0;
...
var _excluded21 = ["axisDirection", "axisId", "hideFirst", "hideLast", "labelFormatter", "onItemClick"];
...
function PiecewiseColorLegend(props) {
  ...
  return (0, import_jsx_runtime62.jsx)(LegendPerItem, _extends({}, other, {
    itemsToDisplay,
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default 'z'
   */
  axisDirection: import_prop_types52.default.oneOf(["x", "y", "z"]),
  /**
   * The id of the axis item with the color configuration to represent.
   * @default The first axis item.
   */
  axisId: import_prop_types52.default.oneOfType([import_prop_types52.default.number, import_prop_types52.default.string]),
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   * The default depends on the chart.
   */
  direction: import_prop_types52.default.oneOf(["column", "row"]).isRequired,
  /**
   * Hide the first item of the legend, corresponding to the [-infinity, min] piece.
   * @default false
   */
  hideFirst: import_prop_types52.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types52.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
  itemGap: import_prop_types52.default.number,
  /**
   * Height of the item mark (in px).
   * @default 20
   */
  itemMarkHeight: import_prop_types52.default.number,
  /**
   * Width of the item mark (in px).
   * @default 20
   */
  itemMarkWidth: import_prop_types52.default.number,
  /**
   * Format the legend labels.
   * @param {PiecewiseLabelFormatterParams} params The bound of the piece to format.
   * @returns {string|null} The displayed label, or `null` to skip the item.
   */
  labelFormatter: import_prop_types52.default.func,
  /**
   * Style applied to legend labels.
   * @default theme.typography.subtitle1
   */
   ...
   * @default 5
   */
  markGap: import_prop_types52.default.number,
  /**
   * Callback fired when a legend item is clicked.
   * @param {React.MouseEvent<SVGRectElement, MouseEvent>} event The click event.
   ...
   * @default 10
   */
  padding: import_prop_types52.default.oneOfType([import_prop_types52.default.number, import_prop_types52.default.shape({
   ...
   * The position of the legend.
   */
  position: import_prop_types52.default.shape({
    horizontal: import_prop_types52.default.oneOf(["left", "middle", "right"]).isRequired,
    vertical: import_prop_types52.default.oneOf(["bottom", "middle", "top"]).isRequired
  }).isRequired
} : void 0;
...
function ChartsAxisHighlight(props) {
  ...
  const {
    axis
  } = React119.useContext(InteractionContext);
  ...
  return (0, import_jsx_runtime63.jsxs)(React119.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime63.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime63.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime63.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime63.jsx)(ChartsAxisHighlightPath, {
...
function ChartsClipPath(props) {
  ...
  return (0, import_jsx_runtime64.jsx)("clipPath", {
    id,
    children: (0, import_jsx_runtime64.jsx)("rect", {
      x: left2 - offset.left,
      y: top2 - offset.top,
...
true ? ChartsClipPath.propTypes = {
  ...
  offset: import_prop_types54.default.shape({
...
var _excluded23 = ["x", "y", "id", "classes", "color"];
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime65.jsx)(HighlightElement, _extends({
    pointerEvents: "none",
    ownerState,
    className: classes.root,
    cx: 0,
...
function LineHighlightPlot(props) {
  ...
  const {
    axis
  } = React122.useContext(InteractionContext);
  ...
  return (0, import_jsx_runtime66.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor_default3(series[seriesId], xAxis[xAxisId], yAxis[yAxisId]);
        return (0, import_jsx_runtime66.jsx)(Element, _extends({
          id: seriesId,
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime67.jsx)(React123.Fragment, {
    children: xTicks.map(({
      value,
      offset
    }) => (0, import_jsx_runtime67.jsx)(GridLine, {
      y1: drawingArea.top,
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime68.jsx)(React124.Fragment, {
    children: yTicks.map(({
      value,
      offset
    }) => (0, import_jsx_runtime68.jsx)(GridLine, {
      y1: offset,
      y2: offset,
      x1: drawingArea.left,
...
var _excluded25 = ["vertical", "horizontal"];
...
function ChartsGrid(inProps) {
  ...
  return (0, import_jsx_runtime69.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
    children: [vertical && (0, import_jsx_runtime69.jsx)(ChartsGridVertical, {
      axis: verticalAxis,
      drawingArea,
      classes
    }), horizontal && (0, import_jsx_runtime69.jsx)(ChartsGridHorizontal, {
      axis: horizontalAxis,
      drawingArea,
      classes
    })]
...
true ? ChartsGrid.propTypes = {
   ...
   */
  horizontal: import_prop_types57.default.bool,
  /**
   * Displays vertical grid.
   */
  vertical: import_prop_types57.default.bool
} : void 0;
...
function ChartsOnAxisClickHandler(props) {
  ...
  const {
    axis
  } = React126.useContext(InteractionContext);
  const {
    xAxisIds,
    xAxis,
    yAxisIds,
  ...
  return (0, import_jsx_runtime70.jsx)(React126.Fragment, {});
}
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime71.jsx)(StyledText, _extends({
    x: left2 + width2 / 2,
    y: top2 + height2 / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime72.jsx)(StyledText2, _extends({
    x: left2 + width2 / 2,
    y: top2 + height2 / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime73.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime73.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}

// node_modules/@mui/x-charts/LineChart/useLineChartProps.js
var _excluded28 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "tooltip", "onAxisClick", "onAreaClick", "onLineClick", "onMarkClick", "axisHighlight", "disableLineItemHighlight", "legend", "grid", "topAxis", "leftAxis", "rightAxis", "bottomAxis", "children", "slots", "slotProps", "skipAnimation", "loading", "highlightedItem", "onHighlightChange", "className", "experimentalMarkRendering"];
...
var LineChart = React130.forwardRef(function LineChart2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiLineChart"
  });
  ...
  return (0, import_jsx_runtime74.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime74.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), (0, import_jsx_runtime74.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime74.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime74.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime74.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime74.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime74.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime74.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime74.jsx)("g", {
      "data-drawing-container": true,
      children: (0, import_jsx_runtime74.jsx)(MarkPlot, _extends({}, markPlotProps))
    }), (0, import_jsx_runtime74.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime74.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime74.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime74.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? LineChart.propTypes = {
   ...
   * @default { x: 'line' }
   */
  axisHighlight: import_prop_types59.default.shape({
    x: import_prop_types59.default.oneOf(["band", "line", "none"]),
    y: import_prop_types59.default.oneOf(["band", "line", "none"])
  }),
  /**
   * Indicate which axis to display the bottom of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types59.default.oneOfType([import_prop_types59.default.object, import_prop_types59.default.string]),
   ...
   * @default false
   */
  disableAxisListener: import_prop_types59.default.bool,
  /**
   * If `true`, render the line highlight item.
   */
  disableLineItemHighlight: import_prop_types59.default.bool,
  /**
   * If `true` marks will render `<circle />` instead of `<path />` and drop theme override for faster rendering.
   */
  experimentalMarkRendering: import_prop_types59.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types59.default.shape({
    horizontal: import_prop_types59.default.bool,
    vertical: import_prop_types59.default.bool
  }),
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
  ...
  highlightedItem: import_prop_types59.default.shape({
    ...
    seriesId: import_prop_types59.default.oneOfType([import_prop_types59.default.number, import_prop_types59.default.string])
  }),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types59.default.oneOfType([import_prop_types59.default.object, import_prop_types59.default.string]),
  /**
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types59.default.shape({
    classes: import_prop_types59.default.object,
    direction: import_prop_types59.default.oneOf(["column", "row"]),
    hidden: import_prop_types59.default.bool,
    itemGap: import_prop_types59.default.number,
    itemMarkHeight: import_prop_types59.default.number,
    itemMarkWidth: import_prop_types59.default.number,
    labelStyle: import_prop_types59.default.object,
    markGap: import_prop_types59.default.number,
    onItemClick: import_prop_types59.default.func,
    padding: import_prop_types59.default.oneOfType([import_prop_types59.default.number, import_prop_types59.default.shape({
    ...
    position: import_prop_types59.default.shape({
      horizontal: import_prop_types59.default.oneOf(["left", "middle", "right"]).isRequired,
      vertical: import_prop_types59.default.oneOf(["bottom", "middle", "top"]).isRequired
    }),
   ...
   * @default object Depends on the charts type.
   */
  margin: import_prop_types59.default.shape({
    bottom: import_prop_types59.default.number,
    left: import_prop_types59.default.number,
    right: import_prop_types59.default.number,
    top: import_prop_types59.default.number
   ...
   */
  onAreaClick: import_prop_types59.default.func,
  /**
   * The function called for onClick events.
   * The second argument contains information about all line/bar elements at the current mouse position.
   * @param {MouseEvent} event The mouse event recorded on the `<svg/>` element.
   * @param {null | AxisData} data The data about the clicked axis and items associated with it.
   */
  onAxisClick: import_prop_types59.default.func,
  /**
   * The callback fired when the highlighted item changes.
   *
   * @param {HighlightItemData | null} highlightedItem  The newly highlighted item.
   ...
   */
  onLineClick: import_prop_types59.default.func,
  /**
   * Callback fired when a mark element is clicked.
   */
  onMarkClick: import_prop_types59.default.func,
  /**
   * The chart will try to wait for the parent container to resolve its size
   * before it renders for the first time.
   *
   ...
   * @default false
   */
  resolveSizeBeforeRender: import_prop_types59.default.bool,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  rightAxis: import_prop_types59.default.oneOfType([import_prop_types59.default.object, import_prop_types59.default.string]),
  /**
   ...
   */
  tooltip: import_prop_types59.default.shape({
    axisContent: import_prop_types59.default.elementType,
    classes: import_prop_types59.default.object,
    itemContent: import_prop_types59.default.elementType,
    slotProps: import_prop_types59.default.object,
    slots: import_prop_types59.default.object,
    trigger: import_prop_types59.default.oneOf(["axis", "item", "none"])
  }),
  /**
   * Indicate which axis to display the top of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  topAxis: import_prop_types59.default.oneOfType([import_prop_types59.default.object, import_prop_types59.default.string]),
  viewBox: import_prop_types59.default.shape({
    height: import_prop_types59.default.number,
    width: import_prop_types59.default.number,
    x: import_prop_types59.default.number,
    y: import_prop_types59.default.number
  }),
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
   ...
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types59.default.arrayOf(import_prop_types59.default.shape({
    classes: import_prop_types59.default.object,
    colorMap: import_prop_types59.default.oneOfType([import_prop_types59.default.shape({
      colors: import_prop_types59.default.arrayOf(import_prop_types59.default.string).isRequired,
      type: import_prop_types59.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types59.default.string,
      values: import_prop_types59.default.arrayOf(import_prop_types59.default.oneOfType([import_prop_types59.default.instanceOf(Date), import_prop_types59.default.number, import_prop_types59.default.string]).isRequired)
    }), import_prop_types59.default.shape({
      color: import_prop_types59.default.oneOfType([import_prop_types59.default.arrayOf(import_prop_types59.default.string.isRequired), import_prop_types59.default.func]).isRequired,
      max: import_prop_types59.default.oneOfType([import_prop_types59.default.instanceOf(Date), import_prop_types59.default.number]),
      min: import_prop_types59.default.oneOfType([import_prop_types59.default.instanceOf(Date), import_prop_types59.default.number]),
      type: import_prop_types59.default.oneOf(["continuous"]).isRequired
    }), import_prop_types59.default.shape({
      colors: import_prop_types59.default.arrayOf(import_prop_types59.default.string).isRequired,
      thresholds: import_prop_types59.default.arrayOf(import_prop_types59.default.oneOfType([import_prop_types59.default.instanceOf(Date), import_prop_types59.default.number]).isRequired).isRequired,
      type: import_prop_types59.default.oneOf(["piecewise"]).isRequired
    })]),
    data: import_prop_types59.default.array,
    dataKey: import_prop_types59.default.string,
    disableLine: import_prop_types59.default.bool,
    disableTicks: import_prop_types59.default.bool,
    domainLimit: import_prop_types59.default.oneOfType([import_prop_types59.default.oneOf(["nice", "strict"]), import_prop_types59.default.func]),
    fill: import_prop_types59.default.string,
    hideTooltip: import_prop_types59.default.bool,
    ...
    labelFontSize: import_prop_types59.default.number,
    labelStyle: import_prop_types59.default.object,
    max: import_prop_types59.default.oneOfType([import_prop_types59.default.instanceOf(Date), import_prop_types59.default.number]),
    min: import_prop_types59.default.oneOfType([import_prop_types59.default.instanceOf(Date), import_prop_types59.default.number]),
    position: import_prop_types59.default.oneOf(["bottom", "top"]),
    reverse: import_prop_types59.default.bool,
    scaleType: import_prop_types59.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types59.default.object,
    slots: import_prop_types59.default.object,
    stroke: import_prop_types59.default.string,
    sx: import_prop_types59.default.oneOfType([import_prop_types59.default.arrayOf(import_prop_types59.default.oneOfType([import_prop_types59.default.func, import_prop_types59.default.object, import_prop_types59.default.bool])), import_prop_types59.default.func, import_prop_types59.default.object]),
    tickFontSize: import_prop_types59.default.number,
    tickInterval: import_prop_types59.default.oneOfType([import_prop_types59.default.oneOf(["auto"]), import_prop_types59.default.array, import_prop_types59.default.func]),
    tickLabelInterval: import_prop_types59.default.oneOfType([import_prop_types59.default.oneOf(["auto"]), import_prop_types59.default.func]),
    tickLabelPlacement: import_prop_types59.default.oneOf(["middle", "tick"]),
    tickLabelStyle: import_prop_types59.default.object,
    tickMaxStep: import_prop_types59.default.number,
    tickMinStep: import_prop_types59.default.number,
    tickNumber: import_prop_types59.default.number,
    tickPlacement: import_prop_types59.default.oneOf(["end", "extremities", "middle", "start"]),
    tickSize: import_prop_types59.default.number,
    valueFormatter: import_prop_types59.default.func
  })),
  /**
   * The configuration of the y-axes.
   * If not provided, a default axis config is used.
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types59.default.arrayOf(import_prop_types59.default.shape({
    classes: import_prop_types59.default.object,
    colorMap: import_prop_types59.default.oneOfType([import_prop_types59.default.shape({
      colors: import_prop_types59.default.arrayOf(import_prop_types59.default.string).isRequired,
      type: import_prop_types59.default.oneOf(["ordinal"]).isRequired,
