...
var InteractionContext = React19.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React19.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React19.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var HighlightedContext = React20.createContext({
  isInitialized: false,
  data: {
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React21.useContext(HighlightedContext);
  if (!isInitialized) {
...
// node_modules/@mui/x-charts/node_modules/@react-spring/web/node_modules/@react-spring/shared/dist/react-spring_shared.modern.mjs
...
// node_modules/@mui/x-charts/node_modules/@react-spring/web/node_modules/@react-spring/core/dist/react-spring_core.modern.mjs
var import_react10 = __toESM(require_react(), 1);

// node_modules/@mui/x-charts/node_modules/@react-spring/web/node_modules/@react-spring/animated/dist/react-spring_animated.modern.mjs
...
// node_modules/@mui/x-charts/node_modules/@react-spring/web/dist/react-spring_web.modern.mjs
...
function useChartId() {
  ...
  return React28.useMemo(() => chartId, [chartId]);
}
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime8.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime8.jsxs)(React31.Fragment, {
...
function useChartGradient() {
  const {
    chartId
  } = React33.useContext(DrawingContext);
  return React33.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React35.useContext(AnimationContext);
  if (!isInitialized) {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React36.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
  ...
  return (0, import_jsx_runtime11.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React39.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React39.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React40.useRef(null);
...
var ChartContainer = React41.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
...
var ResponsiveChartContainer = React43.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
...
function ChartsText(props) {
  ...
  const wordsByLines = React44.useMemo(() => getWordsByLines({
    style,
  ...
  return (0, import_jsx_runtime15.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style,
    children: wordsByLines.map((line, index2) => (0, import_jsx_runtime15.jsx)("tspan", {
      x: x2,
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime18.jsxs)(React48.Fragment, {
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React49.useState(null);
  React49.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ChartsItemTooltipContent(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React51.useContext(ZAxisContext);
...
function ChartsAxisTooltipContent(props) {
  ...
  const {
    zAxisIds,
    zAxis
  } = React53.useContext(ZAxisContext);
  const series = useSeries();
  const colorProcessors = useColorProcessor();
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React53.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React53.useMemo(() => {
...
function LegendPerItem(props) {
  ...
  const theme = useTheme();
  const drawingArea = useDrawingArea();
  const labelStyle = React58.useMemo(
  ...
  const padding = React58.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React58.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React58.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React58.useMemo(() => {
...
function useAxis({
  ...
  const {
    zAxis,
    zAxisIds
  } = React61.useContext(ZAxisContext);
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime28.jsxs)(React62.Fragment, {
...
function ChartsAxisHighlight(props) {
  ...
  const {
    axis
  } = React64.useContext(InteractionContext);
...
//# sourceMappingURL=chunk-5BFNU5PS.js.map
